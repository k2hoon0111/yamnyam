<?php
    ...
    class documentItem extends Object {
        ...
        function getImagePriceSmall() {
        	...
        	$price = $this->getExtraValue(10);
        	
        	$result="";
        	
        	if($price) {
        	
        		$result .= "<div><div style='border-bottom:2px solid red; position:relative; top:10px; left:72px; width:85px;'></div>";
        ...
        /**
         * 11.3.29 - 병웅
         * 상점이름으로부터 상점document_srl을 구함
         **/
        function getDocumentSrlFromName($name) {
        	$args->module_srl=141;
        	$args->title = $name;
			$output = executeQueryArray('document.getDocumentSrlFromName', $args);
