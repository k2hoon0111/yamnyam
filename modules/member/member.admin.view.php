<?php
    ...
    class memberAdminView extends member {
         ...
         * @brief 최근 주문된 위치 보기
         **/
        function dispMemberAdmindeliverPath() {
            $oMemberModel = &getModel('member');
			...
			// 배송현황을 수정했을때
	            ...
	            $document_srl = Context::get('target');
         ...
         * @brief 배달지역분석
         **/
        function dispMemberAdmindeliverGraph() {
            $oMemberModel = &getModel('member');
            ...
            Context::set('module_srl','recent_ordered_list');
            $this->setTemplateFile('recent_ordered_graph');
        }
        
    	function dispMemberAdmindeliverStatus() {
            $oMemberModel = &getModel('member');
            ...
            Context::set('module_srl','recent_ordered_list');
            $this->setTemplateFile('recent_ordered_list_status');
        }
        
    function dispMemberAdminMain() {
            $oMemberModel = &getModel('member');
            ...
            if (!$start_day) $start_day=date("Ymd",strtotime(date("Ymd")."-7 day"));
            Context::set('start_day',$start_day);
            
            $end_day = Context::get('end_day');
            if (!$end_day) $end_day=date('Ymd');
            ...
            Context::set('module_srl','recent_ordered_list');
            $this->setTemplateFile('shop_main');
        }
        
         /**
         * @brief 매출 그래프 보기
         **/
        function dispMemberAdminSalesGraph() {
        	$oMemberAdminModel = &getAdminModel('member');
            $oMemberModel = &getModel('member');
         ...
         * @brief display member list 
         **/
        function dispMemberAdminYamnyamList() {
            ...
            $this->setTemplateFile('member_list_yamnyam');
        }
         ...
         * @brief 회원 가입 폼 목록 출력
         **/
        function dispMemberAdminJoinFormListYamnyam() {
            // 멤버모델 객체 생성
            $oMemberModel = &getModel('member');
            ...
            $this->setTemplateFile('join_form_list_yamnyam');
        }
