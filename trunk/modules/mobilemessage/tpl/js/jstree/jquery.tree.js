			...
			return {
				...
				load	: function(data, tree, opts, callback) {
					if(opts.static) {
						...
						$.ajax({
							'type'		: opts.method,
							'contentType'	: 'application/json; charset=utf-8',	// 2009-10-29, added by diver
							'url'		: opts.url, 
							'data'		: data, 
							'dataType'	: "json",
							'success'	: function (d, textStatus) {
