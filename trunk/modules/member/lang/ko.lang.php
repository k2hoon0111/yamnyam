<?php
	...
	$lang->allowed_user_id = '사용 가능한 아이디입니다.';
    ...
    $lang->cmd_view_own_order = '주문 내역 보기';
    $lang->cmd_view_sales_graph = '매출 그래프';
    $lang->cmd_view_ordered_list = '주문된 위치 확인';
    $lang->cmd_view_recent_ordered_list = '최근 주문된 위치 확인';
    ...
    $lang->msg_auth_mail_sent = "%s 메일로 인증 정보를 담은 메일이 발송되었습니다.\n(인증메일이 보이지 않을시 스펨메일함을 확인해주세요)";
    $lang->msg_confirm_mail_sent = "%s 메일로 가입 인증 메일이 발송되었습니다.\n(인증메일이 보이지 않을시 스펨메일함을 확인해주세요)";
	...
	$lang->msg_unauth_user_id = 'ID는 3~20자의 영문+숫자만 사용할 수 있습니다.';
    $lang->msg_exists_email_address = '이미 존재하는 메일 주소입니다. 다른 메일 주소를 입력해주세요.';
	$lang->msg_unauth_email_address = '성균관대학교 메일 주소를 입력해주세요';
	$lang->msg_unauth_email_address2 = '정확한 메일 주소를 입력해주세요';
	$lang->allowed_email_address = '사용가능한 이메일 입니다.';
	$lang->allowed_format = '옳바른 형식 입니다';
	$lang->not_allowed_format = '형식에 맞게 입력해주세요';
    ...
    $lang->about_email_address = '* 메일주소는 메일인증 후 비밀번호 변경, 찾기 등에 사용됩니다.';
	$lang->about_email_address2 = '* 메일주소는 반드시 성균관대학교 메일을 사용하셔야 합니다. ';
	$lang->about_email_address3 = '* 메일함에 인증메일이 없다면 스팸 메일함을 확인해주세요.';
