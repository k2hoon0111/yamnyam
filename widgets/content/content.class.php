<?php
    ...
    class content extends WidgetHandler {
       ...
       /**
        ...
        function _compile($args,$content_items){
            ...
            $widget_info->closed = $args->closed;
    ...
    class contentItem extends Object {
        ...
        function getSocialInfo() {
        	$preAddress = "./modules/board/skins/yamnyam_foodlist/images/";
        
        	$social_date = $this->getExtraEidValue('social_date');
        	$social_to = $this->getExtraEidValue('social_to');

        	$result="";
        	        	
        	if($social_date!="" && $social_to!="") {
				$social_month = $social_date[4].$social_date[5];
				$social_day = $social_date[6].$social_date[7];

        		$result .= "<div><b>".$social_month."월 ".$social_day."일</b><a>까지</a></div>";
        		$result .= "<div style='float:right;'><b>".$social_to."명</b><a>이면</a></div>";
			}
        ...
        /*숫자를 작은그림으로 표현하기*/
        function getImagePriceSmall() {
        	$preAddress = "./modules/board/skins/yamnyam_foodlist/images/";
        
        	$price = $this->getExtraEidValue('pre_price');
        	
        	$result="";
        	
        	if($price) {
        	
        		$result .= "<div><div style='border-bottom:2px solid red; float:none; position:relative; top:10px; left:65px; width:85px;'></div>";
        ...
        function getImagePrice() {
        	...
        	$price = $this->getExtraEidValue('price');
